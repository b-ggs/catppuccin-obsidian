...
For one of the four dark themes, set `Base color scheme` to `Dark`.
This defaults to Catppuccin Mocha; install Style Settings as described below to change your dark theme flavor to Frappé, Macchiato, or Pinkdrink.
